...
public class ConnVars {
    ...
    public static final String URL_FETCH_SPECIFIC_DRUG = "http://153.104.62.251/android_connect/fetch_druginfo_row.php";
    public static final String URL_FETCH_DRUGINFO_ALL = "http://153.104.62.251/android_connect/fetch_druginfo_all.php";
    public static final String URL_FETCH_SHIPMENT = "http://192.168.0.100/android_connect/fetch_shipment_rows.php";
    public static final String URL_FETCH_PATIENT_GENERAL_INFO="http://153.104.62.62/android_connect/fetch_patientinfo_row.php";
